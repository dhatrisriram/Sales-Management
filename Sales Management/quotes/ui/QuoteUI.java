...
public class QuoteUI {
    ...
    /**
     * Prompts for an integer. Keeps re-prompting if the user enters non-integer input.
     */
    ...
    /**
     * Prompts for a double. Keeps re-prompting if the user enters non-numeric input.
     */
     ...
     * (similar to how the Facade pattern integrates all modules per Harshini's design).
     */
